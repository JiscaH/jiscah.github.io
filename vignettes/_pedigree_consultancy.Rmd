...
I did a postdoc with the Rum Red deer project (https://rumdeer.bio.ed.ac.uk/ ) at Edinburgh University, during which I became fascinated with the intricacies of parentage assignment and further pedigree reconstruction based on genetic data. I continue to assist with or perform the yearly update of its pedigree with the new cohort of calves, as well as for its sister project on Soay sheep ( https://soaysheep.bio.ed.ac.uk/ ). 

...
For each pair, the likelihoods to be half-siblings (HS), grand-parental (GP) or full avuncular (FA) will be identical -- another common [cause for non-assignment](vignette_main/_book/key-points.html#sec:lowAR)
